angular.module('page', ["ideUI", "ideView", "entityApi"])
	...
	.controller('PageController', ['$scope', '$http', 'messageHub', 'entityApi', 'Extensions', function ($scope, $http, messageHub, entityApi, Extensions) {
		...
		$http.get("/services/ts/codbex-companies/gen/codbex-companies/api/entities/DepartmentService.ts").then(function (response) {
		...
		$http.get("/services/ts/codbex-organizations/gen/codbex-organizations/api/entities/TeamService.ts").then(function (response) {
		...
		$http.get("/services/ts/codbex-jobs/gen/codbex-jobs/api/JobAssignment/JobPositionService.ts").then(function (response) {

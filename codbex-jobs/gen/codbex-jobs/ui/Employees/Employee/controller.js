angular.module('page', ["ideUI", "ideView", "entityApi"])
	...
	.controller('PageController', ['$scope', '$http', 'messageHub', 'entityApi', 'Extensions', function ($scope, $http, messageHub, entityApi, Extensions) {
		...
		$http.get("/services/ts/codbex-jobs/gen/codbex-jobs/api/EmployeesSettings/undefinedService.ts").then(function (response) {
		...
		$http.get("/services/ts/codbex-jobs/gen/codbex-jobs/api/Countries/undefinedService.ts").then(function (response) {

...
const validationModules = await Extensions.loadExtensionModules("codbex-jobs-Organizations-Department", ["validate"]);
...
class DepartmentService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-jobs/gen/codbex-jobs/api/Organizations/DepartmentService.ts/" + entity.Id);

...
const validationModules = await Extensions.loadExtensionModules("codbex-jobs-Organizations-Organization", ["validate"]);
...
class OrganizationService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-jobs/gen/codbex-jobs/api/Organizations/OrganizationService.ts/" + entity.Id);

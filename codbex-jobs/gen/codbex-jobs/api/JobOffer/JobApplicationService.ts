...
class JobApplicationService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-jobs.JobOffer.JobApplicationReadOnly") || user.isInRole("codbex-jobs.JobOffer.JobApplicationFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-jobs.JobOffer.JobApplicationFullAccess")) {
            throw new ForbiddenError();
        }
    }

...
import { JobAssignmentRepository, JobAssignmentEntityOptions } from "../../dao/EmployeeAssignment/JobAssignmentRepository";
import { ValidationError } from "../utils/ValidationError";
import { HttpUtils } from "../utils/HttpUtils";
// custom imports
import { NumberGeneratorService } from "/codbex-number-generator/service/generator";

const validationModules = await Extensions.loadExtensionModules("codbex-jobs-EmployeeAssignment-JobAssignment", ["validate"]);
...
class JobAssignmentService {
    ...
    public getAll(_: any, ctx: any) {
        try {
            ...
            let EmployeeAssignment = parseInt(ctx.queryParameters.EmployeeAssignment);
            EmployeeAssignment = isNaN(EmployeeAssignment) ? ctx.queryParameters.EmployeeAssignment : EmployeeAssignment;

            if (EmployeeAssignment !== undefined) {
                options.$filter = {
                    equals: {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-jobs/gen/codbex-jobs/api/EmployeeAssignment/JobAssignmentService.ts/" + entity.Id);

...
export class JobRoleRepository {
    ...
    private async triggerEvent(data: JobRoleEntityEvent | JobRoleUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-jobs-Settings-JobRole", ["trigger"]);
        ...
        producer.topic("codbex-jobs-Settings-JobRole").send(JSON.stringify(data));
    }
}

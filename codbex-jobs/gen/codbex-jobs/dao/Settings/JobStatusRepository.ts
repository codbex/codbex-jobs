...
export interface JobStatusEntityEvent {
...
export interface JobStatusUpdateEntityEvent extends JobStatusEntityEvent {
...
export class JobStatusRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(JobStatusRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: JobStatusEntityOptions = {}): JobStatusEntity | undefined {
    ...
    private async triggerEvent(data: JobStatusEntityEvent | JobStatusUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-jobs-Settings-JobStatus", ["trigger"]);
        ...
        producer.topic("codbex-jobs-Settings-JobStatus").send(JSON.stringify(data));
    }
}

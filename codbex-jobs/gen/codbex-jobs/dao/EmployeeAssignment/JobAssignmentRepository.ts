...
export interface JobAssignmentCreateEntity {
    ...
    readonly EmployeeAssignment?: number;
}
...
export interface JobAssignmentEntityOptions {
    $filter?: {
        equals?: {
            ...
            Team?: number | number[];
            EmployeeAssignment?: number | number[];
        };
        notEquals?: {
            Id?: number | number[];
            Number?: string | string[];
...
export class JobAssignmentRepository {
    ...
    private static readonly DEFINITION = {
        ...
        properties: [
            ...
            },
            {
                ...
                column: "JOBASSIGNMENT_EMPLOYEEASSIGNMENT",
                type: "INTEGER",
            }
        ]
    };
    ...
    private async triggerEvent(data: JobAssignmentEntityEvent | JobAssignmentUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-jobs-EmployeeAssignment-JobAssignment", ["trigger"]);
        ...
        producer.topic("codbex-jobs-EmployeeAssignment-JobAssignment").send(JSON.stringify(data));
    }
}

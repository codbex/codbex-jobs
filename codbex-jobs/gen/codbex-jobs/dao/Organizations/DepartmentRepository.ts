...
export class DepartmentRepository {
    ...
    private async triggerEvent(data: DepartmentEntityEvent | DepartmentUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-jobs-Organizations-Department", ["trigger"]);
        ...
        producer.topic("codbex-jobs-Organizations-Department").send(JSON.stringify(data));
    }
}

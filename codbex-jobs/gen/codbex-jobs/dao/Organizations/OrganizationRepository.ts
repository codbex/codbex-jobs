...
export class OrganizationRepository {
    ...
    private async triggerEvent(data: OrganizationEntityEvent | OrganizationUpdateEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-jobs-Organizations-Organization", ["trigger"]);
        ...
        producer.topic("codbex-jobs-Organizations-Organization").send(JSON.stringify(data));
    }
}
